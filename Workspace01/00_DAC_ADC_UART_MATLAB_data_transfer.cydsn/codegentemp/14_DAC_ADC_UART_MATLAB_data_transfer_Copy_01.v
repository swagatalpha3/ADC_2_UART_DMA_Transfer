// ======================================================================
// 14_DAC_ADC_UART_MATLAB_data_transfer_Copy_01.v generated from TopDesign.cysch
// 06/11/2020 at 21:15
...
module top ;
	...
	wire [0:0] tmpOE__Pin_DAC_out_net;
	wire [0:0] tmpFB_0__Pin_DAC_out_net;
	wire [0:0] tmpIO_0__Pin_DAC_out_net;
	wire [0:0] tmpINTERRUPT_0__Pin_DAC_out_net;
	electrical [0:0] tmpSIOVREF__Pin_DAC_out_net;

	cy_psoc3_pins_v1_10
		#(.id("e0f654b1-8881-4d4d-9162-2f8523edb89a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_DAC_out
		 (.oe(tmpOE__Pin_DAC_out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_DAC_out_net[0:0]}),
		  .analog({Net_95}),
		  .io({tmpIO_0__Pin_DAC_out_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_DAC_out_net),
		  .interrupt({tmpINTERRUPT_0__Pin_DAC_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_DAC_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
